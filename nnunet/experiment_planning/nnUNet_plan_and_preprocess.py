...
def main():
    ...
    for i in task_ids:
        ...
        # 1. 裁剪数据，找到扫描中非0的部分，用bb包起来，把bb里的裁出来。对头部这种目标小的会有用
    ...
    for t in tasks:
        ...
        print(planner_3d, type(planner_3d))
        print("++++++++++++++++ starting 3d planning and prep ++++++++++++++++")
        ...
        print("++++++++++++++++ end 3d planning and prep ++++++++++++++++")

        print("++++++++++++++++ starting 2d planning and prep ++++++++++++++++")
        if planner_2d is not None:
            ...
            if not dont_run_preprocessing:  # double negative, yooo
                exp_planner.run_preprocessing(threads)
        print("++++++++++++++++ end 2d planning and prep ++++++++++++++++")
